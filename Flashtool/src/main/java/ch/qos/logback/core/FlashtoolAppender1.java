 ...
 */
@Slf4j
public class FlashtoolAppender1<E> extends UnsynchronizedAppenderBase<E> {
    ...
    private BufferedOutputStream outputStream = new BufferedOutputStream(byteStream);
    ...
    public void setOutputStream(ByteArrayOutputStream outputStream) {
        ...
        try {
            ...
            this.outputStream = new BufferedOutputStream(byteStream);
            if (encoder == null) {
    ...
    public void setStyledText(StyledText t) {
    	this.text = t;
    }
    ...
    protected void writeOut(E event) throws IOException {
        ...
        if (text != null) {
        	System.out.println("Styled : "+new String(byteArray));
    ...
    private void writeBytes(byte[] byteArray) throws IOException {
        ...
        try {
            ...
            this.targetStream.write(byteArray);
            if (immediateFlush) {
