...
public class PacScriptMethods implements ScriptMethods {
    ...
    public boolean isResolvable(String host) {
        try {
        	...
        	logger.debug("Hostname not resolveable "+host+".");
        }
        return false;
    }
    ...
    public String dnsResolve(String host) {
        try {
        	...
        	logger.debug("DNS name not resolvable : "+ host);
        }
        return "";
    }
	...
	private String getLocalAddressOfType(Class<? extends InetAddress> cl) {
		try {
        	...
        	while (interfaces.hasMoreElements()){
        	    ...
        	    while (addresses.hasMoreElements()){
        	        ...
        	        if (cl.isInstance(adr)) {
        	        	logger.debug("Local address resolved to "+ adr);
        	...
        	logger.debug("Local address not resolvable.");
            return "";
        }
	}
